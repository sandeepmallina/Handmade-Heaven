...
productData(`/productinfo/${props.title}`,{state:{id:props.id,
  title:props.title,
  image:props.image,
  price:props.price,
  rating:props.rating,}})
  ...
  return (
    <div className="product-card">
      ...
      <div className="product-image-container" onClick={addToPreview} >
        <img className="product-image" alt="product1" src={props.image} />
      </div>
      <div className="product-content">
        <div className="product-title-wrap">
          <h3 class="product-name">{props.title}</h3>
          <p className="product-price">
            <small className="text-span"><BiRupee/></small>
        ...
        {/* <img  alt='product1' onClick={addToPreview}
          src={props.image}/> */}
        {(!isPresent)?<button onClick={addToBasket} className="add-to-cart-button"> Add to Basket</button>:
